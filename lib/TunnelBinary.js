...
function TunnelBinary() {
  ...
  if (this.hostOS.match(/darwin|mac os/i)) {
    this.httpPath = 'https://stage-downloads.lambdatest.com/tunnel/mac/LT_Mac.zip';
    ...
    this.windows = true;
    this.httpPath = 'https://stage-downloads.lambdatest.com/tunnel/windows/LT_Windows.zip';
